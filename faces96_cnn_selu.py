...
# (X_train, y_train), (X_test, y_test) = load_faces96_data.load_data()
pickledDataset = open("faces96dataWithImgSalMBD.pickle","rb")
...
model.add(Activation('selu', name='act1'))
...
model.add(Activation('selu', name='act2'))
...
model.add(Activation('selu', name='act3'))
...
model.save('./saved_models/faces96ModelMBDSelu.h5')
